...
<table class="layui-table" lay-data="{width: 1031.33, height:500, url:'${pageContext.request.contextPath}/SelectKCBServlet', page:true, id:'idTest'}" lay-filter="demo">
    <thead>
    <tr>
        <th lay-data="{type:'checkbox', fixed: 'left'}"></th>
        <th lay-data="{field:'kch', width:'20%', sort: true, fixed: true}">ID</th>
        <th lay-data="{field:'kcm', width:'30%'}">课程名称</th>
        <th lay-data="{field:'kxxq', width:'10%'}">开学学期</th>
        <th lay-data="{field:'xs', width:'10%'}">学时</th>
        <th lay-data="{field:'xf', width:'10%'}">学分</th>
        <th lay-data="{fixed: 'right', width:'15.4%', align:'center', toolbar: '#barDemo'}">操作</th>
    </tr>
